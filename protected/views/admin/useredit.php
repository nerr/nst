                                            ...
                                            <div>
                                                <a href="https://gravatar.com/" target="_blank">
                                                    <span class="profile-picture">
                                                        <img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?php echo $avatar; ?>" />
                                                    </span>
                                                </a>
                                                ...
                                                <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                                    <div class="inline position-relative">
                                                        <span class="white"><?php echo $user->username; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<![endif]-->
        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                {
                    $.post(
                        "/nst/index.php?r=admin/userupdate",
                        {mobile: $("#mobile").val(), emaillist: $("#emaillist").val(), userid: $("#userid").val(), newpass: $.md5($.md5($("#newpass").val())), oldpass: $.md5($.md5($("#oldpass").val()))},
                        function(json){
